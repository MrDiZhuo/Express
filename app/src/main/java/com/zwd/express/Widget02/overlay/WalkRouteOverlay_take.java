package com.zwd.express.Widget02.overlay;
 ...
 * @since V2.1.0
 */
public class WalkRouteOverlay_take extends RouteOverlay {
	 ...
	 * @since V2.1.0
	 */
	public WalkRouteOverlay_take(Context context, AMap amap, WalkPath path,
    ...
    private void initPolylineOptions() {
        ...
        mPolylineOptions.color(BaseAppManager.getInstance().getForwardActivity().getResources().getColor(R.color.green)).
                width(10);
    }
    ...
    protected BitmapDescriptor getStartBitmapDescriptor() {
        return BitmapDescriptorFactory.fromResource(R.mipmap.icon_locate);
    }

    @Override
    protected BitmapDescriptor getEndBitmapDescriptor() {
        return BitmapDescriptorFactory.fromResource(R.mipmap.icon_map);
    }
}
